...
% ALVA FIXING
%   - Fixing the fault with the coefficients - CHECK
%   - The reflection is much weaker now though, but maybe expected since
%   the problem is less stiff
