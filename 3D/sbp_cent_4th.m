...
function [H, HI, D1, D2, e_l, e_r, d1_l, d1_r] = sbp_cent_4th(m, h)
    ...
    Q_U = [0, 0.59/0.96, -1/12, -1/32; 
        -0.59/0.96, 0, 0.59/0.96, 0;
        1/12, -0.59/0.96, 0, 0.59/0.96;
        1/32, 0, -0.59/0.96, 0];
    Q(1:4,1:4) = Q_U;
    ...
    M_U = [0.9/0.8, -0.59/0.48, 1/12, 1/48; 
        -0,59/0.48, 0.59/0.24, -0.59/0.48, 0;
        1/12, -0.59/0.48, 0.55/0.24, -0.59/0.48;
        1/48, 0, -0.59/0.48, 0.59/0.24];
